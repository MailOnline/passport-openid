...
function Strategy(options, verify) {
  ...
  if (options.profile) {
      attributes["http://openid.net/schema/namePerson/first"] = "required";
      attributes["http://openid.net/schema/namePerson/last"] = "required";
      attributes["http://openid.net/schema/contact/internet/email"] = "required";
  }
  if (options.attributes) {
    Object.keys(options.attributes).forEach(function (ext) {
      attributes[ext] = options.attributes[ext];
    });
  }
...
Strategy.prototype._parseProfileExt = function(params) {
  ...
  var displayName = params['http://axschema.org/contact/namePerson'];
  var email = params['http://openid.net/schema/contact/internet/email'] || params['http://axschema.org/contact/email'];
  var first = params['http://openid.net/schema/namePerson/first'] || params['http://axschema.org/contact/namePerson/first'];
  var last = params['http://openid.net/schema/namePerson/last'] || params['http://axschema.org/contact/namePerson/last'];
  ...
  if (first || last) {
    ...
    if (first) profile.name.givenName = first;
    if (last) profile.name.familyName = last;
  }
  ...
  Object.keys(this._attributes).forEach(function(attr) {
    profile._rawAttrs[attr] = params[attr];
  });
